...
http.createServer(function (req : http.ServerRequest, res : http.ServerResponse) {
  ...
  fs.readFile('./index.html', function(err : Error, data : Buffer){      //by using fs.readFile content of mentioned file will be store in data and if err accure then errore store in err
